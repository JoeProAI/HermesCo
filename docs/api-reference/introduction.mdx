...
All endpoints live under `/api/hermesco`. On the live deployment the base is `https://hermesco.fly.dev/api/hermesco`. Every route runs on the Node.js runtime and is dynamic (never cached).
