...
<CardGroup cols={2}>
  ...
  <Card title="Money rail" icon="credit-card" href="/concepts/treasury">
    The Treasury holds real capital and records a signed ledger. Stripe Skills create offers, collect revenue, and run deposits.
  </Card>
...
| Models and OpenRouter client | `src/lib/hermesco/models.ts` |
